...
<div class="tabbable">
	...
	<div class="tab-content">
                        ...
                        <div class="thumbnail">
                            <a href="${os.path.relpath(plot_uv.abspath, pcontext.report_dir)}"
                               data-fancybox>
                                <img class="lazyload"
                                     ...
                                     title="UV coverage for ${ms.basename}, ${html.escape(plot_uv.parameters['field_name'], True)} (#${plot_uv.parameters['field']}), spw ${plot_uv.parameters['spw']}"
                            ...
                            <div class="caption">
                                ...
                                <p>UV coverage plot for ${plot_uv.parameters['intent']} field
                                    ${html.escape(plot_uv.parameters['field_name'], True)}
		...
		<div class="tab-pane" id="tabs-baselines">
			...
			<%
			baselines = sorted(ms.antenna_array.baselines_for_antennas([a.id for a in ms.antenna_array.antennas]), key=lambda b: b.length)
			print(baselines)
