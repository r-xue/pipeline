...
def plot_weather(vis='', figfile='', station=[], help=False):
    ...
    plt.plot(timeplot, pressure, markersize=markersize)
    if len(unique_stations) > 1:
        list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
        timeplot2 = matplotlib.dates.date2num(list_of_date_times)
        plt.plot(timeplot2, pressure2, markersize=markersize, color='r')
    ...
    plt.plot(timeplot, temperature, markersize=markersize)
    if len(unique_stations) > 1:
        list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
        timeplot2 = matplotlib.dates.date2num(list_of_date_times)
        plt.plot(timeplot2, temperature2, markersize=markersize, color='r')
    ...
    plt.plot(timeplot, relative_humidity, markersize=markersize)
    if len(unique_stations) > 1:
        list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
        timeplot2 = matplotlib.dates.date2num(list_of_date_times)
        plt.plot(timeplot2, relative_humidity2, markersize=markersize, color='r')
    ...
    if dew_point is not None:
        ...
        plt.plot(timeplot, dew_point, markersize=markersize)
        if len(unique_stations) > 1:
            list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
            timeplot2 = matplotlib.dates.date2num(list_of_date_times)
            plt.plot(timeplot2, dew_point2, markersize=markersize, color='r')
    ...
    adesc = plt.subplot(3, 2, pid)
    plt.plot(timeplot, wind_speed, markersize=markersize)
    if len(unique_stations) > 1:
        list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
        timeplot2 = matplotlib.dates.date2num(list_of_date_times)
        plt.plot(timeplot2, wind_speed2, markersize=markersize, color='r')
    ...
    plt.plot(timeplot, wind_direction, markersize=markersize)
    if len(unique_stations) > 1:
        list_of_date_times = mjd_seconds_to_datetime(mjdsec2)
        timeplot2 = matplotlib.dates.date2num(list_of_date_times)
        plt.plot(timeplot2, wind_direction2, markersize=markersize, color='r')
