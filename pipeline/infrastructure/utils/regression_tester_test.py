...
class TestPipelineRegression(unittest.TestCase):
    ...
    @mock.patch("pipeline.environment.casa_version_string", "6.5.1")
    @mock.patch("pipeline.environment.pipeline_revision", "2023.1.0")
    def test_pick_results_file_valid_cases(self) -> None:
        ...
        reference_files = [
            "test_results_casa-6.5.0-pipeline-2023.1.0",
            "test_results_casa-6.4.0-pipeline-2022.4.0",
            "test_results_casa-6.6.0-pipeline-2023.2.0",  # Exceeds current versions
            "test_results_casa-6.5.1-pipeline-2023.1.0",  # Exact match
        ]

        best_match = self.pipeline._pick_results_file(reference_files)
        self.assertEqual(best_match, "test_results_casa-6.5.1-pipeline-2023.1.0")
    ...
    def test_pick_results_file_exceeding_versions(self) -> None:
        ...
        reference_files = [
            "test_results_casa-6.7.0-pipeline-2023.2.0",  # CASA version too high
            "test_results_casa-6.5.2-pipeline-2023.3.0",  # Pipeline version too high
        ]
    ...
    def test_results_file_heuristics_selects_best_match(self) -> None:
        ...
        reference_dict = {
            "test_results_casa-6.5.0-pipeline-2023.1.0": {
                "CASA version": packaging.version.parse("6.5.0"),
                "Pipeline version": packaging.version.parse("2023.1.0"),
            },
            "test_results_casa-6.4.0-pipeline-2022.4.0": {
                "CASA version": packaging.version.parse("6.4.0"),
                "Pipeline version": packaging.version.parse("2022.4.0"),
            },
            "test_results_casa-6.5.1-pipeline-2023.1.0": {
                "CASA version": packaging.version.parse("6.5.1"),
                "Pipeline version": packaging.version.parse("2023.1.0"),
            },
        }
    ...
    def test_regex_matching(self) -> None:
        ...
        test_cases = [
            ...
            ("invalid_casa_pipeline-2021.1.0", None, "2021.1.0"),  # Missing CASA version
