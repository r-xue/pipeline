...
<%def name="plot_field_group(plot_dict, url_fn, data_spw=False, data_field=False, data_baseband=False, data_tsysspw=False,
...
<%self:plot_field_group plot_dict="${science_amp_vs_freq_plots}"
