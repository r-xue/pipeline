...
def hsd_baseline(fitfunc=None, fitorder=None, switchpoly=None,
    ...
    ***WARNING***
    ...
    Args:
        ...
        switchpoly: Whether to fall back the fits from cubic spline to 1st or 2nd order polynomial when large masks exist at the edges
        ...
        linewindow: Pre-defined line window. If this is set, specified line windows are used as a line mask for baseline subtraction
        ...
        linewindowmode: Merge or replace given manual line window with line detection/validation result. If 'replace' is given, line
        ...
        edge: Number of edge channels to be dropped from baseline subtraction. The value must be a list with length of 2,
