...
from pipeline.hsd.tasks.common.flagcmd_util import mjdsec_to_time_selection

test_cases = [
    (56839.91646527777, '2014/07/01/21:59:42.599999'),
    (56839.91647013888, '2014/07/01/21:59:43.019999'),
    (60414, '2024/04/14/00:00:00.0000000'),
    (60414.9999999999, '2024/04/14/23:59:59.9999912'),
    (60414.999999999985, '2024/04/14/23:59:59.9999987')
]
...
def test_mjdsec2str(mjd: float, expected: str):
    ...
    mjdsec = mjd * 86400
    result = mjdsec_to_time_selection(mjdsec)
