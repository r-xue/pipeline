...
def write_flagcmd(flagtemplate, spw_id, antenna_id, timerange_list, reason=''):
    qa = casa_tools.quanta
    sanitized = reason.replace(' ', '_')
    template = string.Template(f"mode='manual' spw='{spw_id}' antenna='{antenna_id}&&&' timerange='$timerange' reason='SDPL:{sanitized}'\n")
...
class MetaDataReader(object):
    ...
    def _generate_flagcmd(self, flagtemplate, flag_dict, reason=''):
        ...
        for key, rowlist in flag_dict.items():
            ...
            write_flagcmd(flagtemplate, spw_id, antenna_id, timerange_merged, reason)
