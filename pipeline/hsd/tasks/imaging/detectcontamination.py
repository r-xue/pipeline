...
def make_figures(peak_sn, mask_map, rms_threshold, rms_map,
                 masked_average_spectrum, all_average_spectrum,naxis3,peak_sn_threshold,spectrum_at_peak,idy,idx,output_name):
        ...
        if np.nanmin(masked_average_spectrum) <= (-1)*std_value*std_threshold:
            ...
            warning_sentence_mark = termcolor.colored('###############', 'red')
            print(warning_sentence_mark)
