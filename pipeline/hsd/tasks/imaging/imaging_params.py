...
class ReductionGroupParameters(Parameters):
    ...
    def __init__(self, group_id: int, group_desc: 'MSReductionGroupDesc'):
        ...
        self._polslist = None               # List[List[str]]: List of Polarization. NOT USED NOW virtually.
        ...
        self._spwid_list = None             # List[int]: List of Spectral window IDs of _group_desc
        self._spwids = None                 # List[int]: List of Spectral window IDs of _members
