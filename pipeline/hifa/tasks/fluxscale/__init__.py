...
from .gcorfluxscale import SerialGcorFluxscale, GcorFluxscale, GcorFluxscaleResults, SessionGcorFluxscale
...
weblog.add_renderer(SerialGcorFluxscale, renderer.T2_4MDetailsGFluxscaleRenderer(), group_by=weblog.UNGROUPED)
