...
<%block name="title">Create Target Continuum Measurement Sets for Imaging</%block>
...
% else:
    <h4>Target Continuum Measurement Sets</h4>
    ...
    <table class="table table-bordered table-striped" summary="Science target measurement sets">
        ...
        <thead>
           <tr>
            ...
            <th scope="col">Target Continuum Measurement Set</th>
          </tr>
        </thead>
        <tbody>
