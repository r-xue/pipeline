...
class NRORestoreDataInputs(restoredata.RestoreDataInputs):
    ...
    def __init__(self, context, copytoraw=None, products_dir=None, rawdata_dir=None, output_dir=None, session=None,
        ...
        super(NRORestoreDataInputs, self).__init__(context, copytoraw=copytoraw, products_dir=products_dir,
...
class NRORestoreData(restoredata.RestoreData):
    ...
    def _do_importasdm(self, sessionlist, vislist):
        ...
        # InputsContainer.
        container = vdp.InputsContainer(importdata.NROImportData, inputs.context, vis=vislist, session=sessionlist,
    ...
    def _do_applycal(self):
        inputs = self.inputs
        # NROApplyCalInputs operates in the scope of a single measurement set.
        # To operate in the scope of multiple MSes we must use an
        # InputsContainer.
