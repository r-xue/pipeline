...
# Run the procedure
def vlassSEIP_cube(vislist, editimlist_infile, importonly=False, pipelinemode='automatic', interactive=True):
    echo_to_screen = interactive
    casa_tools.post_to_log("Beginning VLA Sky Survey single epoch coarse cube imaging pipeline run ...")
    ...
    try:
        ...
        # add imaging target
        hif_editimlist(parameter_file=editimlist_infile, imaging_mode='VLASS-SE-CUBE')
